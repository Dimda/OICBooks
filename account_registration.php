...
<body>
	...
	$id = 10000000;
  $result = mysql_query("INSERT INTO CUSTOMER(CUSTOMER_ID, FIRST_NAME, LAST_NAME, FURIGANA, GENDER, BIRTH_DATE, EMAIL_ADDRESS, PHONE_NUMBER, PASS_WORD, EMAIL_PERMIT) 
  	VALUES($id, '$first_name', '$last_name', '$phonetic', '$sex', '$birthday', '$email', '$phone_number', '$password', '$mailmagazine' )", $conn);
